...
The pattern match is done on the arguments of the function. It will check number of arguments and them compare the arguments following the rules we saw in "Learning Erlang 3":https://dynamicprogrammer.com/2012/03/19/variables-comparisons-and-dynamic-typing-learning-erlang-3/
