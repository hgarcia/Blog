...
In "a previous post":http://blog.dynamicprogrammer.com/2012/09/10/using-includes-with-angular-js-to-organize-your-ui-modules/ I show how to use includes to partition views.
